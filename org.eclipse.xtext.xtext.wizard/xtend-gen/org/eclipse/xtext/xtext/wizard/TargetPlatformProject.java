  ...
  public CharSequence target() {
    ...
    _builder.newLine();
    {
      ...
      if (_equals) {
        ...
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"junit-jupiter-api\" version=\"[5.0.0,6.0.0)\"/>");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"junit-jupiter-engine\" version=\"[5.0.0,6.0.0)\"/>");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"junit-jupiter-migrationsupport\" version=\"[5.0.0,6.0.0)\"/>");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"junit-jupiter-params\" version=\"[5.0.0,6.0.0)\"/>");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"junit-platform-commons\" version=\"[1.0.0,2.0.0)\"/>");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"junit-platform-engine\" version=\"[1.0.0,2.0.0)\"/>");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"junit-platform-launcher\" version=\"[1.0.0,2.0.0)\"/>");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"junit-platform-runner\" version=\"[1.0.0,2.0.0)\"/>");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"junit-platform-suite-api\" version=\"[1.0.0,2.0.0)\"/>");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"junit-platform-suite-commons\" version=\"[1.0.0,2.0.0)\"/>");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"junit-vintage-engine\" version=\"[5.0.0,6.0.0)\"/>");
        _builder.newLine();
        _builder.append("\t\t\t");
    ...
    _builder.append("\t\t\t");
    _builder.append("<unit id=\"org.objectweb.asm\" version=\"9.9.0\"/>");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("<unit id=\"io.github.classgraph.classgraph\" version=\"0.0.0\"/>");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("<repository location=\"https://download.eclipse.org/tools/orbit/simrel/orbit-aggregation/2025-12\"/>");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("</location>");
    _builder.newLine();
